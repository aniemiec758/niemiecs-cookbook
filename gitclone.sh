...
if [ "$1" = "help" ] ; then
	...
	echo -e "\tExample: $0 https://github.com/arcosin/CS390-NIP_Lab0_skeleton.git https://github.com/aniemiec758/CS390-NIP_Lab0.git CS390-NIP_Lab0 0-lab"
