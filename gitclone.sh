...
if [ -d $4 ] ; then # if the folder they want to create already exists, make absolute sure before trying to replace it
	echo "Error: $4 already exists in this folder!"
	echo -n "Do you REALLY want to replace it? (y/n) "
	read RESP
